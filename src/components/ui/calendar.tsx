  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_middle:
          "aria-selected:bg-accent bg-accent aria-selected:text-accent-foreground",
        day_range_end: "day-range-end",
        day_selected:
          "!text-accent-foreground hover:text-accent-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-primary text-primary-foreground hover:bg-primary",
